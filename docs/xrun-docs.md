...
- ** :appendfile** <a id="appendfile">index</a>
...
- ** :appendnumbparam** <a id="appendnumbparam">index</a>
...
- ** :calcnumbparam** <a id="calcnumbparam">index</a>
...
- ** :command2file** <a id="command2file">index</a>
...
- ** :command2var** <a id="command2var">index</a>
...
- ** :copy** <a id="copy">index</a>
  ...
  - *Uddated:* 2018-11-03
- ** :copy2usb** <a id="copy2usb">index</a>
...
- ** :drivepath** <a id="drivepath">index</a>
...
- ** :infile** <a id="infile">index</a>
  ...
  - *Depends on:* fatal
- ** :ini2xslt** <a id="ini2xslt">index</a>
...
- ** :iniline2var** <a id="iniline2var">index</a>
  ...
  - *Unused:* 
- ** :iniparse4xslt** <a id="iniparse4xslt">index</a>
  ...
  - *Depends on:* inccount
- ** :inisection** <a id="inisection">index</a>
  ...
  - *Unused:* 
- ** :inputfile** <a id="inputfile">index</a>
...
- ** :loopfiles** <a id="loopfiles">index</a>
...
- ** :loopstring** <a id="loopstring">index</a>
...
- ** :outputfile** <a id="outputfile">index</a>
...
- ** :paratextio** <a id="paratextio">index</a>
...
- ** :setinfolevel** <a id="setinfolevel">index</a>
...
- ** :spawnbat** <a id="spawnbat">index</a>
  - *Depreciated:* 
- ** :start** <a id="start">index</a>
  - *Description:* Start a program but don't wait for it.
- ** :start2** <a id="start2">index</a>
  - *Description:* Start a program but don't wait for it.
- ** :sub** <a id="sub">index</a>
...
- ** :taskgroup** <a id="taskgroup">index</a>
