...
#define icon "batr.ico"

[Setup]
OutputBaseFilename=Batrunner-installer
AppName=Batrunner
AppVersion=0.2
DefaultDirName=C:\programs\batrunner
DisableDirPage=true
...
[Icons]
Name: "{group}\Batrunner"; Filename: "{app}\batrunner.hta"; IconFilename: "{app}\setup\{#icon}"
;Name: "{group}\Xrun func documentation"; Filename: "{app}\docs\xrun-docs.md.html"; IconFilename: "{app}\setup\{#icon}"
Name: "{group}\Uninstallers\Batrunner Uninstall"; Filename: "{uninstallexe}" 
...
[Dirs]
Name: "{app}\_Batrunner_Projects\Demos"
